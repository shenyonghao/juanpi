...
class MuYing extends React.Component{
    state={
      goods:[],
      page:3,
      refreshing:false,
      height:0,
      catekey:"muyingtongzhuang",
    }
    render(){
      return <div>
             <PullToRefresh
    ...
    componentDidMount(){
      ...
      axios.get('/api/getBrandClearanceOtherGoods?cate_key=muyingtongzhuang&page=2&pf=m&brandclear=brandclear_127_419_A').then(res=>{
        this.setState({
